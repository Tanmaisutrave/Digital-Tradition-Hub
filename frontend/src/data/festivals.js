const festivals = [
  {
    ...
    name: 'Diwali',
    region: 'North',
    image: 'https://kirkleeslocaltv.com/wp-content/uploads/2021/11/pexels-udayaditya-barua-40785161-1024x682.jpg',
    ...
    quiz: [
      {
        ...
        options: ['Row of lights', 'Festival of colors', 'Harvest celebration', 'Victory dance'],
        answer: 0,
      },
      {
        question: 'Which goddess is worshipped on the main night of Diwali?',
        options: ['Saraswati', 'Durga', 'Lakshmi', 'Parvati'],
        answer: 2,
      },
    ],
    videoId: 'placeholder',
  },
  {
    ...
    name: 'Holi',
    region: 'North',
    image: 'https://i.pinimg.com/originals/cb/bc/2e/cbbc2e31f6682b2289fb2e95f9ccd278.jpg',
    ...
    quiz: [
      {
        question: 'What is the bonfire lit on the eve of Holi called?',
        options: ['Diya Dahan', 'Holika Dahan', 'Agni Puja', 'Rang Ratri'],
        answer: 1,
      },
      {
        question: 'Which demon king\'s son was saved by Lord Vishnu during Holi?',
        options: ['Ravana', 'Kansa', 'Prahlada', 'Hiranyakashipu'],
        answer: 2,
      },
    ],
    videoId: 'placeholder',
  },
  {
    ...
    quiz: [
      {
        question: 'What does the word "Pongal" mean?',
        options: ['To boil over', 'Harvest time', 'Sun festival', 'Sweet rice'],
        answer: 0,
      },
      {
        question: 'Which day of Pongal honors cattle?',
        options: ['Bhogi Pongal', 'Thai Pongal', 'Mattu Pongal', 'Kaanum Pongal'],
        answer: 2,
      },
    ],
    videoId: 'placeholder',
  },
  {
    ...
    quiz: [
      {
        question: 'What is Ganesha\'s favorite sweet offered during the festival?',
        options: ['Ladoo', 'Modak', 'Barfi', 'Halwa'],
        answer: 1,
      },
      {
        question: 'What is the immersion of the Ganesha idol called?',
        options: ['Puja', 'Aarti', 'Visarjan', 'Archana'],
        answer: 2,
      },
    ],
    videoId: 'placeholder',
  },
  {
    ...
    name: 'Navratri',
    region: 'West',
    image: 'https://tse4.mm.bing.net/th/id/OIP.zjJzRIDn7yaCJKW1fjOD9wHaE8?rs=1&pid=ImgDetMain&o=7&rm=3',
    ...
    quiz: [
      {
        question: 'What does "Navratri" mean in Sanskrit?',
        options: ['Nine days', 'Nine nights', 'Nine goddesses', 'Nine colors'],
        answer: 1,
      },
      {
        question: 'Which dance form is most associated with Navratri in Gujarat?',
        options: ['Bharatanatyam', 'Kathak', 'Garba', 'Odissi'],
        answer: 2,
      },
    ],
    videoId: 'placeholder',
  },
  {
    ...
    quiz: [
      {
        question: 'Which demon did Goddess Durga defeat according to mythology?',
        options: ['Ravana', 'Mahishasura', 'Hiranyakashipu', 'Kansa'],
        answer: 1,
      },
      {
        question: 'What is the iconic drum played during Durga Puja called?',
        options: ['Tabla', 'Mridangam', 'Dhak', 'Dholak'],
        answer: 2,
      },
    ],
    videoId: 'placeholder',
  },
  {
    ...
    name: 'Onam',
    region: 'South',
    image: 'https://c8.alamy.com/comp/2G95K41/south-indian-kerala-festival-happy-onam-greetings-background-vector-illustration-design-2G95K41.jpg',
    ...
    quiz: [
      {
        question: 'Which king\'s homecoming does Onam celebrate?',
        options: ['King Rama', 'King Mahabali', 'King Ashoka', 'King Vikramaditya'],
        answer: 1,
      },
      {
        question: 'What is the flower carpet made during Onam called?',
        options: ['Rangoli', 'Kolam', 'Pookalam', 'Alpana'],
        answer: 2,
      },
    ],
    videoId: 'placeholder',
  },
  {
    ...
    quiz: [
      {
        question: 'How many types of Bihu are there?',
        options: ['Two', 'Three', 'Four', 'Five'],
        answer: 1,
      },
      {
        question: 'What is the traditional cloth exchanged during Bihu called?',
        options: ['Dupatta', 'Gamosa', 'Lungi', 'Dhoti'],
        answer: 1,
      },
    ],
    videoId: 'placeholder',
